...
checks mark 30.0\% as passing and expose 70 failures that answer-only
...
\midrule
Refund trace suite & 20 & 100.0\% & 50.0\% \\
Tool-safety trace suite & 30 & 100.0\% & 0.0\% \\
External protocol trace suite & 10 & 100.0\% & 100.0\% \\
Account-admin trace suite & 20 & 100.0\% & 0.0\% \\
Data-pipeline trace suite & 20 & 100.0\% & 50.0\% \\
\midrule
...
total trials, 100.0\% final-answer pass rate, 30.0\% trace-aware pass rate, and
70 answer-only missed failures.
