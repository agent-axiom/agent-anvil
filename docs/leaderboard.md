...
1. A Hugging Face Dataset repository stores accepted `leaderboard_submission.json`
   files and a generated `leaderboard.csv`.
2. A Hugging Face Space reads the dataset and renders the leaderboard with
